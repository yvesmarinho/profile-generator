# Copilot Rules — Profile Generator

> Arquivo gerado automaticamente por `scripts/scaffold.py` em 2026-05-07T15:30:45Z
...
| **Analysis** | `.github/prompts/domain/devops-analysis.prompt.md` | Extra |


Para declarar o modo ativo no início de cada sessão:

```
Modo: PROGRAMMING. Projeto: profile-generator. Perfil: devops-programming.
```
...
|------|---------|-----------|
| 2026-05-07T15:30:45Z | Scaffold inicial criado | Domínio: programming, Linguagem: python |
...
*Gerado por scripts/scaffold.py v1.0.0 | 2026-05-07T15:30:45Z*
